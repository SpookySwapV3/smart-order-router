...
import { Percent, V2_FACTORY_ADDRESSES, V2_FACTORY_INIT_HASH } from '@uniswap/sdk-core';
...
export const routeToString = (
  ...
  const poolFeePath = _.map(pools, (pool) => {
    const factoryAddress = V2_FACTORY_ADDRESSES[pool.token0.chainId];
    const initHashCode = V2_FACTORY_INIT_HASH[pool.token0.chainId];
