...
const SUBGRAPH_URL_BY_CHAIN: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.GOAT_TESTNET]: 'https://api.goat.0xgraph.xyz/api/public/f31d1ab2-5380-484e-bfc2-d2b8d606add5/subgraphs/goatswap-v2/v0.0.1/gn',
  ...
  [ChainId.MONAD]: 'https://api.goldsky.com/api/public/project_clss7z2o15cxh010fdvq909x6/subgraphs/monad-v2/1.0.0/gn',
};
