...
export const CACHE_SEED_TOKENS: {
  ...
  [ChainId.BERA_TESTNET] : {
    WETH: WRAPPED_NATIVE_CURRENCY[ChainId.BERA_TESTNET],
    USDC: USDC_BERA_TEST,
  },
  ...
  [ChainId.GOAT_TESTNET] : {
    WETH: WRAPPED_NATIVE_CURRENCY[ChainId.GOAT_TESTNET],
    USDC: USDC_GOAT_TEST,
  },
  [ChainId.SONIC] : {
  ...
  [ChainId.BERA] : {
    WETH: WRAPPED_NATIVE_CURRENCY[ChainId.BERA],
    USDC: USDC_BERA,
  },
  [ChainId.MANTLE] : {
    WETH: WRAPPED_NATIVE_CURRENCY[ChainId.MANTLE],
    USDC: USDC_MANTLE,
  },
